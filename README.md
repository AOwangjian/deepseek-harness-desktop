...
当前版本 **0.1.2**。正式安装包由 GitHub Actions 在打 `v*` 标签时构建，并挂到 [GitHub Releases](https://github.com/AOwangjian/deepseek-harness-desktop/releases/latest)。

| 产物 | 文件 | 说明 |
| --- | --- | --- |
| NSIS 安装包 | [DeepSeek-Harness-Desktop-Setup-0.1.2.exe](https://github.com/AOwangjian/deepseek-harness-desktop/releases/download/v0.1.2/DeepSeek-Harness-Desktop-Setup-0.1.2.exe) | 可安装、可卸载 |
| 便携版 | [DeepSeek-Harness-Desktop-0.1.2.exe](https://github.com/AOwangjian/deepseek-harness-desktop/releases/download/v0.1.2/DeepSeek-Harness-Desktop-0.1.2.exe) | 免安装，双击即用 |
...
Current version **0.1.2**. Tagged `v*` builds are produced by GitHub Actions and attached to [GitHub Releases](https://github.com/AOwangjian/deepseek-harness-desktop/releases/latest).

| Artifact | File | Notes |
| --- | --- | --- |
| NSIS installer | [DeepSeek-Harness-Desktop-Setup-0.1.2.exe](https://github.com/AOwangjian/deepseek-harness-desktop/releases/download/v0.1.2/DeepSeek-Harness-Desktop-Setup-0.1.2.exe) | Installable / uninstallable |
| Portable | [DeepSeek-Harness-Desktop-0.1.2.exe](https://github.com/AOwangjian/deepseek-harness-desktop/releases/download/v0.1.2/DeepSeek-Harness-Desktop-0.1.2.exe) | No installer, run directly |
